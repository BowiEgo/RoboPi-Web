...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "robopi.title": "RoboPi Plugins",
    "robopi.installed": "Installed",
    "robopi.market": "Plugin Market",
    "robopi.installedEmpty": "No plugins installed",
    "robopi.marketEmpty": "Market is empty. Add entries to {file}, or set ROBOPI_PLUGIN_MARKET_URL to a remote manifest.",
    "robopi.installedVersion": "Installed v{version}",
    "robopi.installable": "Installable",
    "robopi.devBadge": "🧪 dev",
    "robopi.devInProgress": "🧪 In dev (plugins-dev)",
    "robopi.selectHint": "Select a plugin on the left to view its documentation",
    "robopi.localDevDir": "Local dev directory (auto-mounted)",
    "robopi.gitSource": "git: {url}",
    "robopi.localProtected": "Local plugin (protected)",
    "robopi.install": "Install",
    "robopi.installing": "Installing…",
    "robopi.update": "Update",
    "robopi.remove": "Remove",
    "robopi.noReadme": "This plugin has no README.md (add one to its directory to show it here)",
    "robopi.footerHint": "Tip: in dev mode plugins under plugins-dev are auto-mounted (🧪); edits hot-reload within 5 seconds; local/dev plugins are protected, git-installed ones can be updated or removed.",
  },
};
