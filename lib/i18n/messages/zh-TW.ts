...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "robopi.title": "RoboPi 外掛",
    "robopi.installed": "已安裝",
    "robopi.market": "外掛市集",
    "robopi.installedEmpty": "無已安裝外掛",
    "robopi.marketEmpty": "市集為空。編輯 {file} 加入條目，或設定 ROBOPI_PLUGIN_MARKET_URL 指向遠端清單。",
    "robopi.installedVersion": "已安裝 v{version}",
    "robopi.installable": "可安裝",
    "robopi.devBadge": "🧪 dev",
    "robopi.devInProgress": "🧪 開發中（plugins-dev）",
    "robopi.selectHint": "從左側選擇一個外掛查看說明",
    "robopi.localDevDir": "本機開發目錄（自動掛載）",
    "robopi.gitSource": "git: {url}",
    "robopi.localProtected": "本機外掛（受保護）",
    "robopi.install": "安裝",
    "robopi.installing": "安裝中…",
    "robopi.update": "更新",
    "robopi.remove": "移除",
    "robopi.noReadme": "此外掛沒有 README.md（在外掛目錄加入 README.md 即可在此顯示）",
    "robopi.footerHint": "提示：dev 模式下 plugins-dev 下的外掛自動掛載（🧪 標記）；修改外掛檔案後 5 秒內自動熱更新；本機/開發外掛受保護，git 安裝的則可更新與移除。",
  },
};
