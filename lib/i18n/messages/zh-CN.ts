...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "robopi.title": "RoboPi 插件",
    "robopi.installed": "已安装",
    "robopi.market": "插件市场",
    "robopi.installedEmpty": "无已安装插件",
    "robopi.marketEmpty": "市场为空。编辑 {file} 添加条目，或设置环境变量 ROBOPI_PLUGIN_MARKET_URL 指向远程清单。",
    "robopi.installedVersion": "已装 v{version}",
    "robopi.installable": "可安装",
    "robopi.devBadge": "🧪 dev",
    "robopi.devInProgress": "🧪 开发中（plugins-dev）",
    "robopi.selectHint": "从左侧选择一个插件查看说明",
    "robopi.localDevDir": "本地开发目录（自动挂载）",
    "robopi.gitSource": "git: {url}",
    "robopi.localProtected": "本地插件（受保护）",
    "robopi.install": "安装",
    "robopi.installing": "安装中…",
    "robopi.update": "更新",
    "robopi.remove": "移除",
    "robopi.noReadme": "该插件没有 README.md（在插件目录添加 README.md 即可在此显示）",
    "robopi.footerHint": "提示：dev 模式下 plugins-dev 下的插件自动挂载（🧪 标记）；修改插件文件后 5 秒内自动热更新；本地/开发插件受保护，git 安装的可更新与移除。",
  },
};
